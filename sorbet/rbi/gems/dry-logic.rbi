...
class Dry::Logic::Rule
  ...
  include Anonymous_Dry_Core_Equalizer_8
  include Dry::Core::Constants
  include Dry::Core::Equalizer::Methods
  include Dry::Logic::Operators
end
module Anonymous_Dry_Core_Equalizer_8
...
class Dry::Logic::Evaluator
  ...
  def path; end
  include Anonymous_Dry_Core_Equalizer_10
  include Dry::Core::Equalizer::Methods
end
module Anonymous_Dry_Core_Equalizer_10
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
class Dry::Logic::Evaluator::Set
  ...
  include Anonymous_Dry_Core_Equalizer_11
  include Dry::Core::Equalizer::Methods
end
module Anonymous_Dry_Core_Equalizer_11
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
