...
class Dry::Types::Container
  def config; end
  extend Anonymous_Dry_Configurable_Extension_20
  extend Dry::Configurable
  extend Dry::Configurable::ClassMethods
  extend Dry::Core::Container::Configuration
  include Dry::Core::Container::Mixin
end
module Anonymous_Dry_Configurable_Extension_20
end
...
module Anonymous_Dry_Logic_Rule_Interface_26
  def [](input0); end
  def call(input0); end
  def initialize(*); end
end
class Dry::Logic::Rule::Predicate::Predicate2Arity1Curried < Dry::Logic::Rule::Predicate
  include Anonymous_Dry_Logic_Rule_Interface_26
end
...
class Dry::Types::Schema::Key
  ...
  def to_ast(meta: nil); end
  def try(input, &block); end
  extend Anonymous_Dry_Core_Deprecations_Tagged_27
  extend Dry::Core::Deprecations::Interface
...
module Anonymous_Dry_Core_Deprecations_Tagged_27
end
